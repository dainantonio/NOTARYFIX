...
const plans = [
  {
    ...
    features: {
      'Signings': '14/week',
      'Pre-Departure Checklist': true,
      'Signer Confirmation': true,
      'Job Inbox (paste + image)': true,
      'GPS Mileage Tracking': true,
      'Invoice Preview & Send': true,
      'Journal Entries': '10/month',
      'Auto-Closeout Agent': false,
