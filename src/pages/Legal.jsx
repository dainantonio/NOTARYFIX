...
export default function Landing() {
  ...
  // Chips are keyed directly to FAQ answers — no string matching needed
  const FAQ_STARTER_CHIPS = [
    { label: 'How does the AI closeout agent work?',  answer: FAQ[1].a },
    { label: 'Can I manage a team of notaries?',      answer: FAQ[2].a },
    { label: 'What states are supported?',            answer: 'NotaryOS supports all 50 states. Every state has its own configured fee caps, required journal fields, ID rules, and conditional requirements (like California\'s thumbprint law for deeds). Your primary state is set during onboarding and drives all compliance defaults.' },
    { label: 'How much time does the agent save?',    answer: FAQ[6].a },
    { label: 'Is my signer data secure?',             answer: FAQ[3].a },
    { label: 'Can I cancel anytime?',                 answer: FAQ[5].a },
  ];
