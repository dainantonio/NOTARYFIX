...
const SetupProgress = ({ loading, checklist, onToggle }) => {
  if (loading) return <Skeleton className="h-36 w-full rounded-xl" />;
    ...
    <div className="min-h-screen pb-10">
      <div className="mx-auto max-w-[1400px] space-y-8 px-5 py-8 md:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div><SetupProgress loading={loading} checklist={setupChecklist} onToggle={toggleSetup} /></div>
        </div>
          ...
          <div className="space-y-8 xl:col-span-8">
            <Card className="h-[420px] border-slate-200/70 dark:border-slate-700">
              <CardHeader>
                ...
                <Select value={chartType} onChange={(e) => setChartType(e.target.value)} options={[{ label: 'Area', value: 'area' }, { label: 'Bar', value: 'bar' }]} className="w-28" />
              </CardHeader>
              <CardContent>
                {loading ? (
